...
<body>
    <div class="my-5 text-center">
        <h1 class="my-5 fs-1">Mughal Book Shop</h1>
        <div class="address">
            <h1 class="fs-2">G-Block BRANCH</h1>
            <div>14-A, DHA PHASE 1, G-BLOCK, Lahore, Pakistan</div>
        </div>
        <p><span class="fw-bold">NTN #</span>{{$sale[0]->id}}</p>
        <p><span class="fw-bold">Contact # :</span> 03164845501</p>
        <div class="border border-dark my-4">
            <h1 class="fs-2">Sale Receipt</h1>
        </div>

        @foreach ($sale as $sale)
            <div class="text-start my-4">
                
                <p><span class="fw-bold my-2">Invoice #</span> {{$sale->id}}</p>
                <p><span class="fw-bold my-2">Invoice Date:</span> {{ $sale->sale_datetime }}</p>
                <p><span class="fw-bold my-2">Customer Name:</span> {{ $sale->customer->name }}</p>
                <p><span class="fw-bold my-2">Customer Phone:</span> {{ $sale->customer->phone }}</p>
            </div>
            ...
            <div class="row my-3">
                <div class="col-6 fw-bold mt-3">Net Amount:</div>
                <div class="col-6 fs-2">Rs. {{$saletotal['total_sale_price']}}</div> 
            </div>
            <hr>
            <div class="row my-3">
                <div class="col-6">
                    <span class="fw-bold">Saler :</span> {{$sale->user->name}}
                </div>
                <div class="col-6">
                    <span class="fw-bold">Role :</span> {{$sale->user->role}}
                </div>
            </div>
            <p> Software Developed by: Web Nexus Solutions </p>
            <p>Ph: 0316-4845501</p>
        @endforeach
